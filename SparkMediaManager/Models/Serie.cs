...
namespace SparkMediaManager.Models
{
    ...
    public class Serie : BaseModel, IMidia
    {
        ...
        public string StrTitulo { get { return _strTitulo; } set { Set(ref _strTitulo, value); } }
        ...
        public byte[] BytCachePoster { get { return _bytCachePoster; } set { Set(ref _bytCachePoster, value); } }
